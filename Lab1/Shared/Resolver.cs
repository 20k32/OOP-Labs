...
namespace Lab1.Shared
{
    internal static class Resolver
    {
        ...
        public static Type ResolveAccountType(StandardModeAccount instance)
        {
            var instanceType = instance.GetType();

            var resultType = AccountTypes.Values.FirstOrDefault(account => account.Type == instanceType).Type;
